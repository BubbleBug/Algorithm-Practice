...
public class LevelOrderTraversalTest {
    ...
    @Test
    public void testLevelOrderByQueueNullTree() throws Exception {
        TreeNode root=null;
        List<List<Integer>> result=levelOrderTraversal.levelOrderByQueue(root);
        assertEquals(result.size(),0);
    }

    @Test
    public void testLevelOrderByQueueOneLevelTree() throws Exception {
        TreeNode root=new TreeNode(1);
        List<Integer> level=new ArrayList<Integer>();
        level.add(1);
        List<List<Integer>> result=levelOrderTraversal.levelOrderByQueue(root);
    ...
    @Test
    public void testLevelOrderByQueueTwoLevelTree() throws Exception {
        TreeNode root=new TreeNode(1);
        root.left=new TreeNode(2);
        List<Integer> level1=new ArrayList<Integer>();
        level1.add(1);
    ...
    @Test
    public void testLevelOrderByQueueTwoLevelTree2() throws Exception {
        TreeNode root=new TreeNode(1);
        root.left=new TreeNode(2);
        root.right=new TreeNode(3);
        List<Integer> level1=new ArrayList<Integer>();
    ...
    @Test
    public void testLevelOrderByQueueThreeLevelTree() throws Exception {
        TreeNode root=new TreeNode(1);
        root.left=new TreeNode(2);
        root.right=new TreeNode(3);
        root.right.left=new TreeNode(4);
